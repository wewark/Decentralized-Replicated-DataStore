...
public class DRDS {
	...
	public static void main(String[] args) throws Exception {
		...
		IFileAgentImpl node1FileAgent = new IFileAgentImpl("node1");
		IFileAgentImpl node2FileAgent = new IFileAgentImpl("node2");
		...
		node1.getFileManager().subscribeFileEvents(new IFileEventListenerImpl(node1.getFileManager()));
		node2.getFileManager().subscribeFileEvents(new IFileEventListenerImpl(node2.getFileManager()));
